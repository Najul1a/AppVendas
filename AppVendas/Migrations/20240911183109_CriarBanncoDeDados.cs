...
{
    /// <inheritdoc />
    public partial class CriarBanncoDeDados : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VendaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProdutoId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    QtdVenda = table.Column<double>(type: "float", nullable: false),
                    ValorTotalItem = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemDeVendas", x => x.ItemDaVendaId);
                    table.ForeignKey(
                        name: "FK_ItemDeVendas_Produtos_ProdutoId",
                        column: x => x.ProdutoId,
                        principalTable: "Produtos",
                        principalColumn: "ProdutoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemDeVendas_Vendas_VendaId",
                        column: x => x.VendaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemDeVendas_ProdutoId",
                table: "ItemDeVendas",
                column: "ProdutoId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemDeVendas_VendaId",
                table: "ItemDeVendas",
                column: "VendaId");

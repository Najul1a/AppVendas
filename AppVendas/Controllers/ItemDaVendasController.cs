...
namespace AppVendas.Controllers
{
    public class ItemDaVendasController : Controller
    {
        ...
        {
            var applicationDbContext = _context.ItensDaVendas.Include(i => i.Produto).Include(i => i.Venda);
        ...
        public async Task<IActionResult> Details(Guid? id)
        {
            ...
            var itemDaVenda = await _context.ItensDaVendas
                .Include(i => i.Produto)
                .Include(i => i.Venda)
        ...
        public async Task<IActionResult> Create([Bind("ItemDaVendaId,VendaId,ProdutoId,QtdVenda,ValorTotalItem")] ItemDaVenda itemDaVenda)
        {
        ...
        public async Task<IActionResult> Edit(Guid? id)
        {
            ...
            var itemDaVenda = await _context.ItensDaVendas.FindAsync(id);
            if (itemDaVenda == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ItemDaVendaId,VendaId,ProdutoId,QtdVenda,ValorTotalItem")] ItemDaVenda itemDaVenda)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            if (itemDaVenda != null)
            {
                _context.ItensDaVendas.Remove(itemDaVenda);
            }
        ...
        {
            return _context.ItensDaVendas.Any(e => e.ItemDaVendaId == id);
        }
    }
}
